...
function CourseMapDisplay(props) {
    ...
    const getCourseType = (course) => {
        if(course.discipline === "Cmp Sci")
            return "Computer Science"
        if(course.discipline === "MATH" || course.discipline ==="MATHEMATICS")
            return "Mathematics"
        if(course.discipline === "ENGL")
            return "English"
        if(course.type === "MS")
            return "Mathematics"
        if(course.type === "NS")
        ...
        if(course.type === "HFA")
            return "Humanities and Fine Arts"
        if(course.type === "SBS")
            return "Social and behavioral sciences"
        if(course.type === "WOC")
            return "Written and oral communications"
        if(course.type === "FYW")
            return "First year writing"
        if(course.type === "COM")
            return "Communication"
        if(course.type === "AHAG")
            return "American History and Government"
        ...
        <div>
                        ...
                        <Select placeholder='Select course' onChange={(e) => {
                        ...
                        }}>
                            {
                                getRemainingCourses(addObj.term).map(i => (
                                    <option value={JSON.stringify(i)}>{getCourseType(i)} : {i.discipline} {i.number} : {i.name} : {i.credit} Credits</option>
                                ))
                            }
                        </Select>
                    </ModalBody>
            ...
            <Card mt={3}>
                ...
                <List spacing={3} mt={4} size={"lg"}>
                    ...
                    <ListItem>
                        {findTotalCreditsByDiscipline("Cmp Sci")+findTotalCreditsByDiscipline("MATH")>=71 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByDiscipline("Cmp Sci")+findTotalCreditsByDiscipline("MATH")< 71  &&<ListIcon as={MdClose} color='red.500' />}
                        Computer sciences credits are {findTotalCreditsByDiscipline("Cmp Sci")+findTotalCreditsByDiscipline("MATH")} out of 71
                    </ListItem>
                    {/*<ListItem>*/}
                    ...
                    {/*</ListItem>*/}
                    <ListItem>
                        {findTotalCreditsByType("FYW")>=3 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByType("FYW")< 3  &&<ListIcon as={MdClose} color='red.500' />}
                        First year writing credits are {findTotalCreditsByType("FYW")} out of 3
                    </ListItem>
                    <ListItem>
                        {findTotalCreditsByType("COM")>=3 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByType("COM")< 3  &&<ListIcon as={MdClose} color='red.500' />}
                        Communication credits are {findTotalCreditsByType("COM")} out of 3
                    </ListItem>

                    <ListItem>
                        {findTotalCreditsByType("AHAG")>=3 &&<ListIcon as={MdCheckCircle} color='green.500' />}
                        {findTotalCreditsByType("AHAG")< 3  &&<ListIcon as={MdClose} color='red.500' />}
                        American history and government credits are {findTotalCreditsByType("AHAG")} out of 3
                    </ListItem>
                    ...
                    <ListItem>
                        ...
                        Humanities and fine arts credits are {findTotalCreditsByType("HFA")} out of 9
                    </ListItem>
                    <ListItem>
                        ...
                        Social and behavioral sciences credits are {findTotalCreditsByType("SBS")} out of 9
                    </ListItem>
                    {/*<ListItem>*/}
