        ...
        <div>
                ...
                <Card mt={3}>
                    <CardBody>
                        ...
                        <Stack mt={4} spacing={4} direction='row' align='center'>
                            <Button colorScheme='red' size='sm' onClick={()=>{setSummer(true)}} variant={summer?"solid":'outline'}>
                                Yes, I want plans for summer
                            </Button>
                            <Button colorScheme='red' size='sm' onClick={()=>{setSummer(false)}} variant={summer?'outline':"solid"}>
            ...
            <Card mt={3}>
                <CardBody>
                    ...
                    <Stack mt={4} spacing={4} direction='row' align='center'>
                        <Button colorScheme='red' size='sm' onClick={()=>{setNewJoin(true)}} variant={newJoin?"solid":'outline'}>
            ...
            <Center>
                { currentPage === -1 && <Button colorScheme='red' size='lg' mt={5} onClick={()=>{
                    setCurrentPage(currentPage+1)
                }} variant={"outline"}>
                    Next
                </Button>}
            ...
            <Center>
                { currentPage === 0 && <Button colorScheme='red' size='lg' mt={5} onClick={()=>{
                    if(startingSem===""){
                ...
                {currentPage===1 && <Button colorScheme='red' size='lg' mt={5} onClick={()=>{setCurrentPage(currentPage-1)}} variant={"outline"}>
                    Back
                </Button>}
